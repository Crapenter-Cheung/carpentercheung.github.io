...
* 至于GTM150，我认为可以作为一本字典。他太厚了，需要什么的时候再进行查阅是最好的使用方式。
* 推荐的课程便是科大申屠钧超老师的[授课视频](https://lusun.com/f/vTD3VHljW6U)，可以作为一个引导。后续还要自己下功夫看。
...
* 关于无限群的表示论，我不大了解。丘维声的后半本书便在讲局部紧T2群的无线维表示。或许GTM255有更深入的知识？
* 关于对称群\\(S_n\\)的表示，我推荐sagan的The symmetric group（GTM203），他和组合有很大关系，尤其是对称函数理论。这本薄薄的小册子很好懂，内容也很详实。
* 关于李代数表示论，见下。


李代数表示论
====
我不大了解，计划在这一阶段学习。等学完后写一份，预计参考的教材是GTM9、Alexander Kirillov写的[Introduction to Lie Groups and Lie Algebras](https://wiki.math.ntnu.no/_media/ma8402/2013v/kirillov.pdf)。

其实我更关系的是李代数表示论和代数组合（尤其是MacDonald多项式）之间的强烈关联，GTM255内便有我想要的内容。

几何（尤其指代数几何）
=====
我先读完了交换代数、微分流形一系列知识后，草草阅读了Fulton的[An Introduction to Algebraic Geometry](https://dept.math.lsa.umich.edu/~wfulton/CurveBook.pdf)。当有了交换代数的部分观点和几何动机后，对这部书的阅读变得并不困难。此书通俗易懂，习题也并不是很难。
此书中给我印象最大的便是Bezout定理和它之后在平面几何中的应用，十分有趣。奇点分解的内容在GTM52中也有涉及。

科大杨金榜老师同样也有授课的[视频](https://tysunseven.github.io/video/Algebraic_Geometry_2022F.html)和杨老师手写的[讲义](https://jbyang1987.github.io/Teaching/2022%20%E7%A7%8B%20Algebraic%20Geometry.html)。
